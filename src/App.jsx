    ...
    if(u&&u.password===loginForm.p){
      ...
      if(prevMsgs.length>0&&groqKey){
        ...
        try{
          ...
          const briefing=await callGroq({apiKey:groqKey,system:`You are Sentinel, an executive management brain. ${lang==='es'?'Respond in Spanish.':'Respond in English only. Never use Spanish.'} Be concise and direct. Use **bold** to highlight what matters.`,messages:[{role:"user",content:briefingPrompt}],maxTokens:500});
